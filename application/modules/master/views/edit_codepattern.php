          ...
          <div class="col-md-4">
            <form action="" method="post">
              <div class="form-group <?php echo form_error('prefix') ? 'has-error' : '' ?>">
                ...
                <input class="form-control" type="text" name="prefix" value="<?= $get_codepattern['prefix']; ?>" />
                ...
                <tbody>
                  ...
                  <?php foreach ($codepattern as $dt) : ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?= base_url('master/hapus_codepattern/' . $dt['id']); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda yakin ? data tidak dapat dikembalikan lagi...');">Delete</a>
                      </td>
                    </tr>
                    <?php $i++; ?>
                  <?php endforeach; ?>
