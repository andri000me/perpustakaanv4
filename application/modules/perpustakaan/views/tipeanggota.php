  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <div class="box-tools">
<a href="<?= base_url('perpustakaan/tipeanggota') ?>" class="btn btn-warning">Daftar Tipe Anggota</a>&nbsp;&nbsp;
<a href="<?= base_url('perpustakaan/tambahtipeanggota') ?>" class="btn btn-primary">Tambah Tipe Anggota</a>
                </div>
      </div>
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            <form action="<?= base_url('perpustakaan/hapus_tipeanggota') ?>" method="post">
                ...
                <tbody>
                  ...
                  <?php foreach ($tipeanggota as $dt) : ?>
                    <tr>
                      ...
                      <td><a href="<?= base_url('perpustakaan/edit_tipeanggota/' . $dt['id']); ?>" class="btn btn-info btn-xs">Edit</a></td>
