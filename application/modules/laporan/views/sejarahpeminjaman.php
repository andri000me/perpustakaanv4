...
<option value="1"<?= set_select('status_peminjaman', '1'); ?>>Telah Kembali</option>
              ...
              <a href="<?= base_url('laporan/sejarahpeminjaman'); ?> " class="btn btn-default">Cancel</a>
            </form>
          </div>
          <!-- /Filter Laporan -->
          <div class="col-md-12">
...
<a href="<?php echo site_url('laporan/sejarahpeminjaman_pdf/'.$start_date.'/'.$end_date.'/'.$status_peminjaman.'/'.$member_id.'/'.$item_kode.'/'.$judul); ?>" target='blank' class='btn btn-default'><img src="<?= base_url('assets/images/'); ?>pdf.png"> Export ke PDF</a>
<a href="<?php echo site_url('laporan/sejarahpeminjaman_excel/'.$start_date.'/'.$end_date.'/'.$status_peminjaman.'/'.$member_id.'/'.$item_kode.'/'.$judul); ?>" target='blank' class='btn btn-default'><img src="<?= base_url('assets/images/'); ?>xls.png"> Export ke Excel</a>
<?php }?>
</div>
        </div>
      </div>
