      ...
      <div class="box-body">
        ...
        <form action="<?php base_url('menu/submenuedit') ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control <?= form_error('sort') ? 'is-invalid' : '' ?>" id="sort" name="sort" placeholder="Submenu sort" value="<?= $getsubmenu['sort']; ?>">
            <div class="invalid-feedback">
              <?= form_error('sort') ?>
            </div>
          </div>
          <div class="form-group">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="1" name="is_active" id="is_active" <?= $getsubmenu['is_active'] == '1' ? 'checked' : ''; ?>>
