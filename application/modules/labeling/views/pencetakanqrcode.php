  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <div class="box-tools">
        <a href="<?= base_url('labeling/batalkan_antrianqrcode') ?>" class="btn btn-danger"onclick="return confirm('Anda yakin ?');"><i class="fa fa-fw fa-trash"></i>BATALKAN ANTRIAN PENCETAKAN</a>&nbsp;&nbsp;<a href="<?= base_url('labeling/cetak_qrcode') ?>" class="btn btn-info"target="new"><i class="fa fa-fw fa-print"></i>CETAK</a></div>
      </div>
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            <form action="<?= base_url('labeling/tambah_eksemplarqrcode') ?>" method="post">
