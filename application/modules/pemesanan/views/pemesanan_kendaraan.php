  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <form class="form-horizontal" action="<?php base_url('pemesanan/kendaraan') ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group <?= form_error('kendaraan') ? 'has-error' : '' ?>">
            <label for="kendaraan" class="col-sm-4 control-label">Kendaraan [ELF / Krista] <span class="text-red">*</span></label>
            <div class="col-sm-8">
              <input class="form-control" type="text" name="kendaraan" value="<?php echo set_value('kendaraan','ELF'); ?>" />
              <?= form_error('kendaraan', '<span class="help-block">', '</small>'); ?>
            </div>
          </div>
      ...
      <div class="box-footer">
        ...
        <a href="<?= base_url('pemesanan/kendaraan'); ?> " class="btn btn-default">Cancel</a>
        &nbsp;&nbsp;
        <a href="<?= base_url('pemesanan/kendaraancalendar'); ?> " target="new"class="btn btn-success">Calendar</a>
      </div>
      <!-- /.box-footer -->
      </form>
    </div>
      ...
      <div class="box-body">
        ...
        <div class="table-responsive">
          <table class="table table-hover" id="example2">
            ...
            <tbody>
              <?php $i = 1; ?>
              <?php foreach ($pemesanan_kendaraan as $dt) : ?>
                <tr>
                  <th><?= $i; ?></th>
                  <td><?= $dt['tglmulai']; ?></td>
                  <td><?= $dt['tglselesai']; ?></td>
                  ...
                  <td>
                    <a href="<?= base_url('pemesanan/kendaraanhapus/' . $dt['id']); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda yakin ? data tidak dapat dikembalikan lagi...');">Delete</a>&nbsp;&nbsp;
                  </td>
                </tr>
                <?php $i++; ?>
              <?php endforeach; ?>
