...
<a href="<?= base_url('bibliography/tambahbuku') ?>" class="btn btn-primary">Tambah Buku</a>
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            <form action="<?= base_url('bibliography/hapus_buku') ?>" method="post">
                ...
                <tbody>
                  ...
                  <?php foreach ($buku as $dt) : ?>
                    <tr>
                      <td><?= $dt['judul']; ?></td>
                      <td><?= $dt['isbn']; ?></td>
                      <td align="center"><b><?= get_eksemplarbuku($dt['id']) ?></b> <a href="<?= base_url('bibliography/tambaheksemplar/' . $dt['id']); ?>" class="btn btn-success btn-xs"><i class="fa fa-fw fa-plus"></i></a></td>
