...
(10, 'The Definitive Guide to MySQL 5', '11', '', '', '20', '2', '1', '1', '2', '101112', '3', '55', '6', '55', '88', '000', '005.75/85-22 Kof d', '10', '99', '061219063004.jpg', NULL, '1', '1', 'perpustakaan/buku', '55', '2019-12-08 11:23:12'),
(11, 'PHP 5 for dummies', '', '', '', '1', '', '', '', '2', '111213', '', '', '', '', '', '000', '006.7/86-22 Woy a', '5', '', '1575081061225.jpg', NULL, NULL, NULL, '', '', '2019-12-08 11:22:57'),
(12, 'Linux In a Nutshell', '5', '', '', '1', '', '', '3', '2', '121212', '', '', '', '', '', '010', '', '', '', '061219074849.jpg', NULL, NULL, NULL, '', '', '2019-12-08 11:22:35');
...
ALTER TABLE `pp_bahasa`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `language_name` (`nama`);
...
ALTER TABLE `pp_gmd`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `gmd_name` (`nama`),
  ADD UNIQUE KEY `gmd_code` (`kode`);
...
ALTER TABLE `pp_loan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `item_code` (`item_kode`),
  ADD KEY `member_id` (`member_id`),
  ADD KEY `input_date` (`last_update`,`user_id`);
...
ALTER TABLE `pp_lokasi`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `location_name` (`nama`);
...
ALTER TABLE `pp_member_type`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `member_type_name` (`nama`);
...
ALTER TABLE `pp_penerbit`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `publisher_name` (`nama`);
...
ALTER TABLE `pp_pengarang`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `author_name` (`nama`);
...
ALTER TABLE `pp_statusitem`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `item_status_name` (`nama`);
...
ALTER TABLE `pp_tempatterbit`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `place_name` (`nama`);
...
ALTER TABLE `pp_tipeisi`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `content_type` (`nama`),
  ADD KEY `code` (`kode`);
...
ALTER TABLE `pp_tipemedia`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `media_type` (`nama`),
  ADD KEY `code` (`kode`);
